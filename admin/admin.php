...
<ul id="topgan" class="topnav">
  ...
  <li><a id="buttonnews" onclick="navbar()" href="addgallery.php">Gallery</a></li>
...
<h2 id="gallery" class="header">Post News</h2>

<div class="container">
  <form method="POST" enctype="multipart/form-data">
    <input type="text" name="inputjudul" placeholder="Masukan Judul Berita ..." required>
    <textarea name="inputkonten" placeholder="Masukan Konten Berita ..."></textarea>
...
if(isset($_POST['submit']))
 {
  ...
  if(empty($judul)){
   ...
   $errMSG = "Please Enter Your Konten.";
  }
  ...
  if(!isset($errMSG))
  {
   $sql = "INSERT INTO post (id, judul, gambar, konten, tanggal) VALUES ('$id', '$judul', 'images/$userpic', '$konten', '$date')";
